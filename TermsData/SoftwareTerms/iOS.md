...
imageUrl: "https://techterms.com/img/xl/ios_980.png"
---
...
Since the iPhone is a **touchscreen** device, the iOS **graphical user interface** utilizes touch and voice input instead of a **keyboard** and **mouse**. You can tap, hold, or swipe your finger on the touchscreen to interact with **apps** and objects on the screen. Tapping and swiping on certain parts of the screen lets you move between apps and access special system screens. For example:
* tapping on an app's icon on the Home screen launches that app
* swiping down from the top shows the Notification center
* swiping left and right moves between Home screens
* You can also use the Siri voice assistant to issue some commands and use **speech recognition** in the place of keyboard input.
...
### **References**
*Pickle, B. (2023, February 20). iOS Definition. Retrieved 2026, Apr 29, from https://techterms.com*