...
![TP-Link AX1800 home router](https://techterms.com/img/xl/router_124.png)
...
- **A modem** converts the digital signal from a computer network into a format that can be transmitted over telephone or cable lines to provide a connection to the Internet.
- **A modem** is assigned an IP address by the ISP.
...
### **References**
*Pickle, B. (2022, September 22). Router Definition. Retrieved 2026, Apr 28, from https://techterms.com*