...
imageUrl: "https://techterms.com/img/xl/usb_149-2.png"
---
...
1. **USB 1.0** (white USB-A and USB-B — very rare) → 1.5 **Mbps**

2. **USB 1.1** (white USB-A and USB-B, Mini-USB) → 12 Mbps

3. **USB 2.0** (black USB-A and USB-B, Mini-USB, Micro-USB) → 480 Mbps

4. **USB 3.0 / SuperSpeed** (blue USB-A and USB-B, Micro-USB B) → 5 **Gbps**

5. **USB 3.1 / SuperSpeed+** (green USB-A and USB-B, USB Type C) → 10 Gbps
...
### **References**
*Christensson, P. (2021, August 24). USB Definition. Retrieved 2026, Apr 28, from https://techterms.com*