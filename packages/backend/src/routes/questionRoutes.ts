...
// Thêm verifyToken vào middleware
router.post("/questions", verifyToken, async (req: Request, res: Response) => {
  try {
    const { lessonId, termId, questionText, optionA, optionB, optionC, optionD, correctOption, xpReward } = req.body;
