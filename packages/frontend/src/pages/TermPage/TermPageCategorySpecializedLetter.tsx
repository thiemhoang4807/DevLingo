...
export default function TermPageCategorySpecializedLetter() {
    ...
    const termList_li = termList.map(el => (
        <li key={el} className="list-none bg-[#E8E7E7] dark:bg-[#4A4A4A] rounded-[6px] border border-[#B9B8B8] dark:border-[#777676] flex flex-row gap-[16px] items-center p-[16px] h-[66px] cursor-pointer">
            <div className="icon w-[32px] h-[32px] rounded-[6px] flex items-center justify-center bg-linear-to-b from-[#B1B1B1] to-[#FFFFFF] dark:to-[#4B4B4B]">
