...
export default function TermPageCategorySpecializedLetter() {
    ...
    const termList_li = termList.map(el => (
        <li key={el} className="list-none bg-[#E8E7E7] rounded-[6px] border border-[#B9B8B8] flex flex-row gap-[16px] items-center p-[16px] h-[66px] cursor-pointer">
            <div className="icon w-[32px] h-[32px] rounded-[6px] flex items-center justify-center bg-linear-to-b from-[#B1B1B1] to-[#FFFFFF]">
                <p className="cursor-default font-bold text-[14px] text-[#000000] leading-[20px]">
                    A
                </p>
            </div>

            <div className="content flex-1 text-left">
                <p className="font-[400] text-[16px] text-[#000000] leading-[24px]">
                    {el}
                </p>
            </div>
        </li>
    ...
    return createPortal(
        ...
        <div className="inter container flex flex-col gap-[50px]">
            ...
            <div className="container__titile">
                <h2 className="font-bold text-[30px] text-[#000000] text-left leading-[32px]">
